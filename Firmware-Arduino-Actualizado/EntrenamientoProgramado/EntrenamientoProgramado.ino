//          PROGRAMA DE ENTRENAMIENTO PROGRAMADO

/**Este código constituye un entrenamiento completo y funcional para el brazo robótico
*  sin intervención del pc, es decir, como el nombre del archivo lo indica, es un entrenamiento programado
*  también es importante notar, que por problemas de memoria en el arduino, los vectores de aprendizaje
*  no pueden tener (los 3) una lngitud superior a 550-600
*/
...
void loop() {
  ...
  for(i = 0; i<nDist; i++)
  {
    ...
    Serial.println(DistanMax);
    Serial.println(tamTotalVec);
